...
.main-page-background {
    ...
    width: 100vw; 
    height: 100vh; 
    background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBYP87BKv5eDGZ11k_DV-czLvRcZXBaa6lgQ&s");
...
with st.sidebar:
    ...
    st.subheader ("Inspeccion Vehicular")

# --- Contenido Principal de la Página (RECORRIDO) ---

# Título de la Página
st.title("INSPECCION VEHICULAR")
...
st.markdown(
    ...
    'Inspeccion de estado de la flota .'
    '</p>',
    unsafe_allow_html=True
)
