...
.main-page-background {
    ...
    width: 100vw; 
    height: 100vh; 
    background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAsLvkXC65ftjy8B8Q15nFd_dcrutv-0I2SA&s");
...
with st.sidebar:
    ...
    st.subheader ("Elaboracion de Informes")
...
st.markdown(
    ...
    'Diseño y elaboracion de Informes .'
    '</p>',
    unsafe_allow_html=True
)
